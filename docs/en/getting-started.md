...
Live APEXlang commands require SQLcl **26.1 or newer**, APEX **26.1 or newer**, a valid database connection, and privileges for the target workspace and schema. See [Oracle's APEXlang prerequisites](https://docs.oracle.com/en/database/oracle/sql-developer-command-line/26.1/sqcug/prerequisites-apexlang.html). ORDS **26.1.1** introduced the required APEXlang support; see [ORDS 26.1.1 release notes](https://www.oracle.com/tools/ords/ords-relnotes-26.1.1.html). For the SQLcl 26.1.2 line, Oracle lists Java **17 or 21** in its [release notes](https://www.oracle.com/tools/sqlcl/sqlcl-relnotes-26.1.2.html). Check the relevant release documentation when selecting another version.
